...
#line 133 "finalAssignment.tab.c"
...
{
       0,   101,   101,   131,   139,   140,   144,   145,   146,   150,
     153,   159,   165,   173,   174,   175,   179,   206,   219,   228,
     234,   242,   246,   252,   256,   260,   263,   270,   271,   275,
     276,   281,   282,   283,   287,   288,   289,   290,   291,   295,
     296,   301,   302,   306,   307,   308,   309,   310,   314,   333,
     347,   361,   375
};
#endif
...
#line 1336 "finalAssignment.tab.c"
    break;
...
#line 1404 "finalAssignment.tab.c"
    break;

  case 17: /* tensor_dims: T_INTEGER T_COMMA tensor_dims  */
#line 206 "finalAssignment.y"
                                  {
...
#line 1422 "finalAssignment.tab.c"
    break;

  case 18: /* tensor_dims: T_INTEGER  */
#line 219 "finalAssignment.y"
              {
...
#line 1443 "finalAssignment.tab.c"
    break;

  case 20: /* stmt: T_ID T_ASSOP tensor_op  */
#line 234 "finalAssignment.y"
                         {
    if (!tensorGraph) tensorGraph = create_tensor_graph();
...
#line 1456 "finalAssignment.tab.c"
    break;
...
#line 1464 "finalAssignment.tab.c"
    break;
...
#line 1489 "finalAssignment.tab.c"
    break;

  case 25: /* stmt: T_PRINT expr  */
#line 260 "finalAssignment.y"
                 {
      (yyval.ast) = newNode(0, T_PRINT, "print", 0,0.0f, NULL, (yyvsp[0].ast));
    }
#line 1497 "finalAssignment.tab.c"
    break;

  case 26: /* stmt: T_READ T_ID  */
#line 263 "finalAssignment.y"
                {
...
#line 1612 "finalAssignment.tab.c"
    break;
...
#line 1618 "finalAssignment.tab.c"
    break;
...
#line 1624 "finalAssignment.tab.c"
    break;
...
#line 1630 "finalAssignment.tab.c"
    break;
...
#line 1636 "finalAssignment.tab.c"
    break;
...
#line 1660 "finalAssignment.tab.c"
    break;
...
#line 1679 "finalAssignment.tab.c"
    break;

  case 50: /* tensor_op: T_ID T_MULTOP T_ID  */
#line 347 "finalAssignment.y"
                       {
      if (!tensorGraph) tensorGraph = create_tensor_graph();
...
#line 1698 "finalAssignment.tab.c"
    break;

  case 51: /* tensor_op: T_TRANSPOSE T_OPENPAR T_ID T_CLOSEPAR  */
#line 361 "finalAssignment.y"
                                          {
      if (!tensorGraph) tensorGraph = create_tensor_graph();
...
#line 1736 "finalAssignment.tab.c"
    break;


#line 1740 "finalAssignment.tab.c"
